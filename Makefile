...
install: certs
	...
	helm upgrade --install dev ./helm --set image.repository=k8s-rep --set image.tag=latest --set-file caCertificate=./certs/ca.crt --set loggregatorCertificateSecret=cert --set locket.certificateSecret=cert --set "nodeSelector=null" --wait --namespace default
